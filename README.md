...
| GRID 2 | DX11 | x86 | ⚠️ Partial | Top half of Half SBS visible, but content shifted to bottom quarters. `hardware_settings_config.xml` needs `stereo enabled="true"` |
| GRID Autosport | DX11 | x86 | ⚠️ Partial | Top half of Half SBS visible, but content shifted to bottom quarters. `hardware_settings_config.xml` needs `stereo enabled="true"` |
| Hitman: Absolution | DX11 | x86 | ✅ Half SBS+TAB working | Tested at 2560×1440 and 4K. Perfect stereo. |
| Sleeping Dogs | DX11 | x86 | ✅ Half SBS+TAB working | Half SBS and TAB both output correctly at 4K. |
| Sleeping Dogs: Definitive Edition | DX11 | x64 | ✅ Half SBS working | Has undocumented native AMD HD3D support. |
| Sniper Elite V2 | DX11 | x86 | ✅ Half SBS working | Confirmed working with shadow approach. |
| Sniper Elite III | DX11| x86| ✅ Half SBS working | `customersupportlogging` beta branch only. Main branch skips HD3D driver loading. |
| Sniper Elite 4 | DX11/12| x64| ✅ Half SBS working | DX11 only. DX12 might be possible, but need to make a DX12 wrapper first. |
| Sniper Elite: Nazi Zombie Army | DX11 | x86 | ✅ Half SBS working | ResizeBuffers fix resolved display bug. Minor color shift. |
| Sniper Elite: Nazi Zombie Army 2 | DX11 | x86 | ✅ Half SBS working | ResizeBuffers fix resolved display bug. Minor color shift. |
...
| Half-Life 2 | DX9 | x86 | ✅ | Not loading | Suspect files placed in wrong location |
...
| King Arthur: The Role-Playing Wargame | DX9 | x86 | ✅ | - | iZ3D specifies the 'King Arthur: The Druids' expansion pack |
| King's Bounty: The Legend | DX9 | x86 | ✅ | - | - |
| Left 4 Dead | DX9 | x86 | ✅ | Working | Source Engine, has iZ3D profile |
| Left 4 Dead 2 | DX9 | x86 | ✅ | Working | Source Engine, has iZ3D profile |
...
| Portal | DX9 | x86 | ✅ | Not loading | Suspect files placed in wrong location |
| Portal 2 | DX9 | x86 | ✅ | - | - |
...
| The Lord of the Rings Online: Shadows of Angmar | DX9/DX10/DX11 | x86/x64 | ✅ | - | Not sure if this convers the modern The Lord of the Rings Online version. |
